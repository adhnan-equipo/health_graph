...
class StepChartController extends ChangeNotifier {
  List<StepData> _data;
  ChartViewConfig _config;
  ProcessedStepData? _selectedData;
  List<ProcessedStepData> _processedData = [];
  ...
  List<ProcessedStepData> get processedData => _processedData;

  ProcessedStepData? get selectedData => _selectedData;
  ...
  void _processData() {
    ...
    // Sort data by date
    final sortedData = List<StepData>.from(_data)
    ...
    _processedData = StepDataProcessor.processData(
      sortedData,
      _config.viewType,
      startDate,
      endDate,
  ...
  void selectData(ProcessedStepData? data) {
